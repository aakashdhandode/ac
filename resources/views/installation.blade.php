            ...
            <div class="col-sm-7">
                <div class="wizard">
                    ...
                    <div class="tab-content mt-4" id="main_form">
                        <h5 class="pb-1"><b>Installation/Un-installation</b></h5>
                         <!-- step 1.1 Choose issues -->
                        
                         <div class="tab-pane active" role="tabpanel" id="step8">
                            <div class="rate form-height">
                                <h5>Choose type of service</h5>
                                <div class="row pt-3">
                                    <div class="col-sm-6">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="Installation">
                                            <label class="form-check-label">
                                            Installation
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" value="Un-installation">
                                            <label class="form-check-label">
                                            Un-installation
                                            </label>
                                        </div>
                                ...
                                <div class="call pt-2">
                                    <!-- <a href="">
                                        ...
                                        help</a> -->
                                    <div class="pt-2" style="margin-top: 153px;">
                        ...
                        <div class="tab-pane" role="tabpanel" id="step1">
                            <div class="rate form-height">
                                ...
                                <div class="call pt-3" style="margin-top: 59px;">
                                    <a href="">
                                        <i class="fa fa-phone" aria-hidden="true"></i>Call Service Engineer for
                                        help</a>
                                    <div class="pt-2">
